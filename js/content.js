    ...
    chrome.runtime.sendMessage({
        ...
        Object.keys(res2).forEach(function(key, index) { //for each in long list
            ...
            if(data[idx].isAdvertiser && data[idx].extensionEnabled) {
                ...
                var p = userDataResponse.partnerName;
                if(p === "Foxwoods") {
                    buttonHTML = "<div style=\"margin-bottom: 0px;\"><img class=\"searchResultDeal\" style=\"height: 25px; display: inline-block; margin-bottom:-5px;\" src=\""+userDataResponse.searchResultLogoUrl+"\"></img>"+"<a class=\"btn btn-primary activate-btn google-activate\" href=\""+elems[index].getAttribute('href')+"\"style=\"margin-bottom: 5px !important; margin-left: 15px; padding: 10px 15px; background-color:"+userDataResponse.buttonColorCode+"; border-color: #FF3D02; border-radius: 0px !important; border-width: 2px; color: "+userDataResponse.buttonColorCode+"; display: inline-block; margin-bottom: 0; font-weight: normal; text-align: center; vertical-align: middle; -ms-touch-action: manipulation; touch-action: manipulation; cursor: pointer; background-image: none; white-space: nowrap; padding: 10px 15px; font-size: 12px; line-height: 1;\">Click to earn " + data[idx].reward + "</a></div>";
                } else {
                    buttonHTML = "<div style=\"margin-bottom: 0px;\"><img class=\"searchResultDeal\" style=\"height: 25px; display: inline-block; margin-bottom:-5px;\" src=\""+userDataResponse.searchResultLogoUrl+"\"></img>"+"<a class=\"btn btn-primary activate-btn google-activate\" href=\""+elems[index].getAttribute('href')+"\"style=\"margin-bottom: 5px !important; margin-left: 15px; padding: 10px 15px; background-color:"+userDataResponse.buttonColorCode+"; border-color: #FF3D02; border-radius: 0px !important; border-width: 2px; color: #ffffff; display: inline-block; margin-bottom: 0; font-weight: normal; text-align: center; vertical-align: middle; -ms-touch-action: manipulation; touch-action: manipulation; cursor: pointer; background-image: none; white-space: nowrap; padding: 10px 15px; font-size: 12px; line-height: 1;\">Click to earn " + data[idx].reward + "</a></div>";
                }
