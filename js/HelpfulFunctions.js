...
const helpfulFunctions = {
  Functions: {
    ...
    parseRspToHtml: (rsp) => {
      ...
      var doc = parser.parseFromString(rsp, "text/html");
      return doc
    },
      ...
      setColor: function (color) {
        return new Promise((resolve, reject) => {
          chrome.browserAction.setBadgeBackgroundColor(
            { color },
            async function () {
              helpfulFunctions.Extension.Badge.getText().then((result) => {
                resolve(result);
              });
            }
          );
  ...
  xmlRequests: {
    ...
    xmlPost: (link, body, type = "application/json") => {
      return new Promise((resolve, reject) => {
        var xhttp = new XMLHttpRequest();
        xhttp.onload = function () {
          resolve(this.responseText)
